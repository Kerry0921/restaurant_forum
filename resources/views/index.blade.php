                              ...
                              <div class="col" style="padding:20px;">
                                <div class="card" style="width: 18rem;">
                                  ...
                                  <div class="card-body">
                                    ...
                                    <a href="detail?detail={{$index->rName}}" name="detail" value="{{$index->rName}}"><h3 class="card-title">{{$index->rName}}</h3></a>
                                    <p class="card-text">{{$index->rType}}</p>
                                    <form method="get" action="{{route('like')}}">
                                    <a href="restaurant" class="btn btn-primary">Go somewhere</a>
                                    <a href="/"><button  type="submit" class="btn btn-primary" value="{{$index->rName}}" name="like">追蹤</button></a></form>
                                </div>
                                </div>
                              </div>
                            @endforeach</div>
