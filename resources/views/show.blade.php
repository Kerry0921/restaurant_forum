...
<body>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="col-sm" style="text-align: center;">
                                <img src="https://d1gpbxqmt7wq2i.cloudfront.net/asset/mobile/images/logo/logo_moments_zh.png"width="200">
                  </div>
                  <div class="col-sm" style="text-align: right;">
                    ...
                    <div class="container">
                            ...
                            <div class="row">@foreach($restaurant as $type)
                              <div class="col" style="padding:20px;">
                                <div class="card" style="width: 18rem;">
                                  ...
                                  <div class="card-body">
                                    ...
                                    <h3 class="card-title">{{$type->rName}}</h3>
                                    <p class="card-text">{{$type->rType}}</p>
                                  
                                    <a href="restaurant" class="btn btn-primary">Go somewhere</a>
                                    <a href="restaurant" class="btn btn-primary">追蹤</a>
                                </div>
                                </div>
                              </div>
                            @endforeach</div>
                                          ...
                                          <div class="col-sm">
                                                <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                          ...
                                                          <a class="dropdown-item" href="{{route('type.show',$index->rType)}}">1</a>
                                                          <a class="dropdown-item" href="#">2</a>
                                                          <a class="dropdown-item" href="#">3</a>
